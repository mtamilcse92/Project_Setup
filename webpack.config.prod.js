...
let envConfig = path.join(__dirname, 'config', 'env.prod.js');
let htmlConfig = {
...
export default {
  ...
  module: {
    loaders: [
      {test: /\.jsx?$/, include: [path.join(__dirname, 'config'), path.join(__dirname, 'src')], exclude: /node_modules/, loader: 'babel'},
